...
import com.xm666.noitathespire.cards.Freeze;
import com.xm666.noitathespire.util.ModUtil;

public class FreezeFielding extends AbstractPower {
    ...
    public FreezeFielding(AbstractCreature owner, int amount) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        if (info.type != DamageInfo.DamageType.THORNS && info.type != DamageInfo.DamageType.HP_LOSS && info.owner != null && info.owner != this.owner && damageAmount > 0) {
            ...
            this.addToTop(new MakeTempCardInHandAction(freeze));
        }
