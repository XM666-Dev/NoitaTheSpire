...
import com.xm666.noitathespire.powers.BoomerangCast;
...
public class BoomerangSpells extends VariableCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(
                new ApplyPowerAction(p, p, new BoomerangCast(p, magicNumber))
        );
        this.addToBot(
                new ApplyPowerAction(p, p, new DamageBoost(p, variable))
        );
    }
}
