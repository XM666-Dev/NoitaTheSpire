...
public class MagicGuard extends VariableCard {
    ...
    public MagicGuard() {
        ...
        this.cardsToPreview = new GuardingLight();
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        NoitaTheSpire.playAudio("shield_activate_0");
        GuardingLight light = new GuardingLight();
        this.addToBot(
