...
import com.xm666.noitathespire.actions.BlockAndDiscardAttackAction;
import com.xm666.noitathespire.util.ModUtil;

import static com.xm666.noitathespire.characters.Mina.PlayerColorEnum.MINA_PURPLE;

public class ProjectileEnergyShield extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(
                new BlockAndDiscardAttackAction(
                        p,
                        99,
                        block
                )
