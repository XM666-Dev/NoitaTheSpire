...
import com.xm666.noitathespire.powers.FasterLevitate;
import com.xm666.noitathespire.util.ModUtil;

import static com.xm666.noitathespire.characters.Mina.PlayerColorEnum.MINA_PURPLE;

public class FasterLevitation extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(
                new ApplyPowerAction(p, p, new FasterLevitate(p, magicNumber))
        );
    }
}
